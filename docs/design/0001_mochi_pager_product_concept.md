...
| Caption | Sliding text line beneath the eyes renders assistant speech, paced against rendered audio (at most one segment ahead); exits right on completion and clears immediately on barge-in | Gateway transcript deltas + playback cursor |
