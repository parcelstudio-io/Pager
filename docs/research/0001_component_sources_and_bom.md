...
|---:|---|---:|---|---|
| 1 | M5Stack CoreS3 Lite, K128-LITE | $44.90 | [M5Stack](https://shop.m5stack.com/products/m5stack-cores3-lite-esp32s3-iot-dev-kit?variant=46532030497025) | Integrated screen, touch, dual microphones, speaker/amp, synchronized speaker-feedback input, battery, microSD, Wi-Fi/BLE, IMU, and ESP32-S3 let us validate the concurrent interaction/audio path without breadboard noise. |
...
|---|---|---|---|
| M5Stack CoreS3 Lite (K128-LITE) | **No listing exists.** The M5Stack official Amazon store carries CoreS3 and CoreS3 SE, not the Lite | [DigiKey 27689559](https://www.digikey.com/en/products/detail/m5stack-technology-co-ltd/K128-LITE/27689559), 65 in stock, expect $44.90 (DigiKey holds M5Stack MSRP across the family) | Next business day; M5Stack direct ships Shenzhen, 1–3 weeks |
