...
These primers are written for a software engineer moving into connected hardware. Each stays focused enough to read in roughly three printed pages and links decisions back to the current product.

1. [System architecture: from a button press to a voice reply](0001_system_architecture.md)
